...
data_path1 = "../samples.csv"
data_path2 = "samples-for-request.csv" 
df1 = pd.read_csv(data_path1)
df1["id"] = df1["sample-prefix"] + " " + df1["sample-id"]
df2 = pd.read_csv(data_path2)
df2["species"] = df2["species"].str.replace("Anaxyrus ", "")
