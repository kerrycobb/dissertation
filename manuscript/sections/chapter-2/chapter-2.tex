...
Stacks2 v2.6.1 \parencite{rochette2019}, allowing for 2 mismatches for rescuing reads. 
...
used a clustering threshold of 90\% sequence similarity, and left the remaining
parameters with the default values. 
vcftools v0.1.17 \parencite{danecek2011} 
...
\ldots
% I collected *** toads that most closely resembled \textit{A. americanus}
% and *** toads that most closely resembled \textit{A. terrestris}.

% Table 1


% *** samples were borrowed from museum collections. 
