\embedHeightFigure{0.6}{clust-80-indel-16-snps-0p3-samples-25-include-phyco-neb-1-tree.pdf}{
  ...
  to millions of years using a secondary time calibration (\textit{Materials and Methods}). 
  ...
  Created using ggplot2 \parencite{wickam2016}, ggtree \parencite{yu2017}, and treeio \parencite{wang2020}. 
}{fig:phycoeval}