\newcommand{\mycomment}[1]{{\color{pgreen}{[KAC comment: #1]}}}
...
\newcommand{\fbranch}{$f$-branch\xspace}


\newcommand{\iqtreefigs}{\cref{fig:iqtree,fig:iqtree2}}

\newcommand{\nebulifer}{\textit{Incilius nebulifer}\xspace}
\newcommand{\incilius}{\textit{Incilius}\xspace}
\newcommand{\rhinella}{\textit{Rhinella}\xspace}
\newcommand{\anaxyrus}{\textit{Anaxyrus}\xspace}
\newcommand{\americanus}{\textit{americanus}\xspace}
\newcommand{\boreas}{\textit{boreas}\xspace}
\newcommand{\amer}{\textit{A.\ americanus}\xspace}
\newcommand{\terr}{\textit{A.\ terrestris}\xspace}
\newcommand{\fowl}{\textit{A.\ fowleri}\xspace}
\newcommand{\wood}{\textit{A.\ woodhousii}\xspace}
\newcommand{\baxteri}{\textit{A.\ baxteri}\xspace}
\newcommand{\cognatus}{\textit{A.\ cognatus}\xspace}
\newcommand{\debilis}{\textit{A.\ debilis}\xspace}
\newcommand{\hemiophrys}{\textit{A.\ hemiophyrs}\xspace}
\newcommand{\houstonensis}{\textit{A.\ houtonensis}\xspace}
\newcommand{\californicus}{\textit{A.\ californicus}\xspace}
\newcommand{\microscaphus}{\textit{A.\ microscaphus}\xspace}
\newcommand{\punctatus}{\textit{A.\ punctatus}\xspace}
\newcommand{\quercicus}{\textit{A.\ quercicus}\xspace}
\newcommand{\speciosus}{\textit{A.\ speciosus}\xspace}


\newcommand{\dsuite}{\textit{dsuite}\xspace}
\newcommand{\dtools}{\textit{dtools}\xspace}
...
\newcommand{\scipy}{\textit{SciPy}\xspace}
\newcommand{\scikitpost}{\textit{scikit-posthocs}\xspace}

\newcommand{\phycoeval}{\textit{phycoeval}\xspace}
\newcommand{\Phycoeval}{\textit{Phycoeval}\xspace}
\newcommand{\sumphycoeval}{\textit{sumphycoeval}\xspace}
...
\newcommand{\iqtree}{\textit{IQ-TREE}\xspace}
\newcommand{\pyrad}{\textit{ipyrad}\xspace}
